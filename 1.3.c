...
int main() {
   ...
   printf("Si programa isveda %d sveiku neneigiamu skaiciu sekos pasikartojimo daznius\n", SIZE);
   ...
   while(counter < SIZE){
      ...
      if((scanf("%d", &num) == 1) && (getchar() == '\n')){
         if ((num >= 0) && (num <= FREQ_SIZE)){
            ...
            printf("%d elementas ivestas sekmingai\n", counter);
         } else {
